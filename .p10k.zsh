# Generated by Powerlevel10k configuration wizard on 2020-03-23 at 02:25 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|aws-vault|awsdev|awsdadmin|awsadmin'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='k9s|gcloud|gcs'
   # Google cloud color.
